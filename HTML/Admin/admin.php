<?php
include '../HTML/conn.php'; //connect the connection page

if(empty($_SESSION)) // if the session not yet started 
   session_start();

if(!isset($_SESSION['username'])) { //if not yet logged in
  echo file_get_contents("../HTML/admin-log.php");// send to login page
  exit;
} 
?>
...
<html>
  ...
  <body class="form-page">
    ...
    <div class="buy">
      <h4>Admin</h4>
      <form name="myForm" class="sell-form" action="../HTML/admin-db.php" method="post" onsubmit="return validateRegister()" enctype="multipart/form-data">
